...
label limboend:
    ...
    call message_start("Karen", "Dining hall closes in 30 minutes, wanna meet there now?") from _call_message_start_5
    play sound "audio/phone_notif.mp3"
    call message("Karen", "?") from _call_message_2
    play sound "audio/phone_notif.mp3"
    call message("Karen", "15 minutes left for fooood") from _call_message_3
    play sound "audio/phone_notif.mp3"
