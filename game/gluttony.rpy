...
label gluttonybeginday2:
    ...
    if josh_hasnumber == True:
        ...
        call message_start("Josh", "Yo, wanna have lunch together today?") from _call_message_start_4
        play sound "audio/phone_notif.mp3"
        call message("Josh", "I’m hungry like a beast for some pizza.") from _call_message_1
        play sound "audio/phone_notif.mp3"
        call reply_message("Yeah, dude, name a dining hall!") from _call_reply_message
